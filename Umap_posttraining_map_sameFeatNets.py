...
config.out_dir2 = '/volume1/scratch/ehereman/results_featuremapping/posttrainingmap_eogtoc34_samec34network_map5pat'
...
with tf.Graph().as_default() as c34fi_graph:
    ...
    with sess1.as_default():
        ...
        best_dir1 = os.path.join(config.checkpoint_path, "best_model_outputlayer")
