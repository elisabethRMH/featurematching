...
for pat_group in range(len(di2[number_patients])):
    ...
    config.out_dir = '/esat/asterie1/scratch/ehereman/results_adversarialDA/baseline_e2earnn_1ch_losssum'
...
np.save('/esat/asterie1/scratch/ehereman/results_featuremapping/posttrainingmap_eogtoc34_diffnetTL_map{:d}pat/acc_matrix.npy'.format(number_patients),acc_matrix )

fig1, ax1 = plt.subplots()
ax1.set_title('Accuracies for feature mapping method \n trained on groups of {:d} patients \n EOG network from transfer learning'.format(number_patients))
